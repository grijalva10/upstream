...
- **Windows**: [Windows Terminal](https://github.com/microsoft/terminal) — canvases spawn in split panes
- **Unix/macOS**: [tmux](https://github.com/tmux/tmux) — canvases spawn in split panes
